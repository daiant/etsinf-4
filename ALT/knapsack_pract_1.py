...
def knapsack_backward(W, v, w):
    """
    Knapsack con PD hacia detrÃ¡s.
    Devuelve:
            1) El mÃ¡ximo beneficio
            2) El nÃºmero de estados de la matriz de PD.
    """
...
def knapsack_forward(W, v, w):
    ...
    Devuelve:
            1) El mÃ¡ximo beneficio
            2) El nÃºmero de estados activos que ha explorado hasta acabar (TODO).
    """
    Vcurr = {0:0.}
...
def measure_time(function, arguments,
    ...
    necesario pasarle una funciÃ³n que establezca las condiciones
...
def measure_knapsack_functions():
    ...
    Aumentar la talla del problema aumentando el nÃºmero de objetos a
    ...
    de mochila (anÃ¡lisis de datos APAREADOS).

    Reportar, por salida estÃ¡ndar, para cada talla:

     - El tiempo medio de ejecuciÃ³n de cada algoritmo.
